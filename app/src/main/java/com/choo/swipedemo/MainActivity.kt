...
import com.choo.swipedemo.ui.theme.SwipeDemoTheme
...
fun MainScreen() {
    ...
    val childBoxSlides = 30.dp

    val swipeableState = rememberSwipeableState("L")
    val widthPx = with(LocalDensity.current) {
        (parentBoxWidth - childBoxSlides).toPx()
    }
    ...
    Box(
        ...
        Box(Modifier.size(10.dp).background(Color.DarkGray, shape = CircleShape).align(Alignment.Center))
